...
import { Sizes, VariantForm, VariantFormProps } from "../../types";
import { ChangeEvent } from "react";
import DeleteIcon from "@mui/icons-material/Delete";

const VariantFormTest = ({
	variant,
	sizes,
    handleTypeChange,
	handlePriceChange,
			...
			<Grid container spacing={1} sx={{ mb: 1 }}>
				...
				<Grid item xs={2}>
					<TextField
						...
						label="Price"
						value={variant.price}
						onChange={(e: ChangeEvent<HTMLInputElement>) => handlePriceChange(parseInt(e.target.value))}
						variant="outlined"
						size="small"
						type="number"
						autoComplete="off"
				...
				<Grid item xs={2}>
					<TextField
						...
						label="Cost"
						value={variant.cost}
						onChange={(e: ChangeEvent<HTMLInputElement>) => handleCostChange(parseInt(e.target.value))}
						variant="outlined"
						size="small"
						type="number"
						autoComplete="off"
				...
				<Grid item xs={2}>
					<TextField
						...
						onChange={(e: ChangeEvent<HTMLInputElement>) => handleStocksChange(parseInt(e.target.value))}
						variant="outlined"
						size="small"
						type="number"
						autoComplete="off"
...
export default VariantFormTest;
