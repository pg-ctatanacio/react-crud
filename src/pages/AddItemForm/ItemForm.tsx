...
type ItemFormParam = {
	...
	onPriceChange?: (e: React.ChangeEvent<HTMLInputElement>, idx?: number) => void;
	onCostChange?: (e: React.ChangeEvent<HTMLInputElement>, idx?: number) => void;
	onStockChange?: (e: React.ChangeEvent<HTMLInputElement>, idx?: number) => void;
	onCategoryChange?: (e: SelectChangeEvent) => void;
	onSizeChange?: (value: Sizes | null, idx?: number) => void;
};

const ItemForm = ({ item, onSubmitClick, onCategoryChange, onNameChange }: ItemFormParam) => {
